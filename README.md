# Realistic city traffic simulator 2D, with the ability to construct your own city, written in Qt C++. Application made for advanced C++ programming subject in school - ZPR (Zaawansowane programowanie w C++).
